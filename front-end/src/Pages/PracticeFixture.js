    ...
    <div style={{"marginTop":"30px"}}>
        <Table responsive striped bordered hover variant='dark' className='tableStyle'>
            ...
            <tbody>
                ...
                <tr>
                    <td style={{"textAlign":"center"}}>10/14/2022</td>
                    <td style={{"textAlign":"center"}}>8 pm - 10 pm</td>
                    <td style={{"textAlign":"center"}}>6B</td>
                    <td style={{"textAlign":"center"}}>Moinul, Zahedul, Shaheen</td>
                </tr>
                <tr>
                    <td style={{"textAlign":"center"}}>10/18/2022</td>
                    <td style={{"textAlign":"center"}}>8 pm - 10 pm</td>
                    <td style={{"textAlign":"center"}}>5A, 5B</td>
                    <td style={{"textAlign":"center"}}>Abu Sohel, Rupom, Shaheen, Rezwan, Mona, Nafis</td>
                </tr>
                <tr>
                    <td style={{"textAlign":"center"}}>10/19/2022</td>
                    <td style={{"textAlign":"center"}}>8 pm - 10 pm</td>
                    <td style={{"textAlign":"center"}}>3B</td>
                    <td style={{"textAlign":"center"}}>Omar, Manar, Moinul</td>
                </tr>
                <tr>
                    <td style={{"textAlign":"center"}}>10/21/2022</td>
                    <td style={{"textAlign":"center"}}>8 pm - 10 pm</td>
                    <td style={{"textAlign":"center"}}>1A</td>
                    <td style={{"textAlign":"center"}}>Munna, Sami, Zahedul</td>
                </tr>
                <tr>
                    <td style={{"textAlign":"center"}}>10/23/2022</td>
                    <td style={{"textAlign":"center"}}>8 pm - 10 pm</td>
                    <td style={{"textAlign":"center"}}>2A</td>
                    <td style={{"textAlign":"center"}}>Mona, Rezwan, Manar</td>
                </tr>
                <tr>
                    <td style={{"textAlign":"center"}}>10/24/2022</td>
                    <td style={{"textAlign":"center"}}>8 pm - 10 pm</td>
                    <td style={{"textAlign":"center"}}>1A</td>
                    <td style={{"textAlign":"center"}}>Shajal, Rashed, Masu</td>
                </tr>
                <tr>
                    <td style={{"textAlign":"center"}}>10/24/2022</td>
                    <td style={{"textAlign":"center"}}>8 pm - 10 pm</td>
        ...
        <Table responsive striped bordered hover variant='dark' className='tableStyle'>
            <thead>
                    <tr>
                        <th 
                            style={{"backgroundColor":"yellow", "justifyContent":"center","color":"black", "textAlign":"center"}} 
                            colSpan={4}>Practice Round 2: Austin Sports Center-Woodward,  
                            <a 
                                href='https://goo.gl/maps/o7beunWFW6Bi6wJ46'
                            > 
                                425 Woodward St, Austin
                            </a>
                        </th>
                    </tr>   
                    <tr>
                        <th style={{"backgroundColor":"yellow", "justifyContent":"center","color":"black", "textAlign":"center"}} colSpan={4}>Reporting time: 15 minutes before match</th>
                    </tr>    
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td style={{"textAlign":"center"}}>CVB1, CVB2</td>
                    <td style={{"textAlign":"center"}}>Shajal, Sami, Polin, Munna, Rashed</td>
                </tr>
                <tr>
                    <td style={{"textAlign":"center"}}>10/22/2022</td>
                    <td style={{"textAlign":"center"}}>10 am - 12 pm</td>
                    <td style={{"textAlign":"center"}}>CVB2</td>
                    <td style={{"textAlign":"center"}}>Abu Sohel, Rupom, Nafis</td>
                </tr>
            </tbody>
        </Table>
    </div>
